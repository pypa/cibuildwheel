...
def get_python_configurations(build_selector):
    ...
    python_configurations = [
        ...
        PythonConfiguration(identifier='cp38-manylinux_x86_64', path='/opt/python/cp38-cp38m'),
        ...
        PythonConfiguration(identifier='cp38-manylinux_i686', path='/opt/python/cp38-cp38m'),
    ]
