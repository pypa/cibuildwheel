...
def get_python_configurations(build_selector: BuildSelector) -> List[PythonConfiguration]:
    python_configurations = [
        ...
        # PyPy
        PythonConfiguration(version='2.7', identifier='pp27-macosx_x86_64', url='https://buildbot.pypy.org/nightly/trunk/pypy-c-jit-99644-795ec9075b51-osx64.tar.bz2'),
        PythonConfiguration(version='3.6', identifier='pp36-macosx_x86_64', url='https://buildbot.pypy.org/nightly/py3.6/pypy-c-jit-99642-1b6c86236b6d-osx64.tar.bz2'),
    ]
