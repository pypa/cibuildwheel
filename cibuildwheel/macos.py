...
def setup_python(python_configuration: PythonConfiguration,
    ...
    is_arm64 = python_configuration.identifier.endswith('arm64')
    is_universal2 = python_configuration.identifier.endswith('universal2')
    ...
    building_arm64 = is_arm64 or is_universal2
...
def build(options: BuildOptions) -> None:
    ...
    try:
        ...
        for config in python_configurations:
            ...
            is_arm64 = config.identifier.endswith('arm64')
            is_universal2 = config.identifier.endswith('universal2')
