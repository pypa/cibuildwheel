...
def get_python_configurations(build_selector: BuildSelector) -> List[PythonConfiguration]:
    python_configurations = [
        ...
        # PyPy
        PythonConfiguration(version='2.7', identifier='pp27-macosx_x86_64', url='https://buildbot.pypy.org/nightly/issue3240/pypy-c-jit-99608-0dd47a080f97-osx64.tar.bz2'),
