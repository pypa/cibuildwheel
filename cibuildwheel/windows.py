...
def get_python_configurations(build_selector):
    ...
    python_configurations = [
        ...
        # PyPy
        PythonConfiguration(version='2.7', arch='32', identifier='pp27-win32', url='https://bitbucket.org/pypy/pypy/downloads/pypy2.7-v7.3.1rc3-win32.zip'),
        PythonConfiguration(version='3.6', arch='32', identifier='pp36-win32', url='https://bitbucket.org/pypy/pypy/downloads/pypy3.6-v7.3.1rc3-win32.zip'),
    ]
