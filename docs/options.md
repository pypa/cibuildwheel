...
instead of strings for items that are natually a list. Multiline strings also
work just like in in the environment variables. Environment variables will take
...
- For `pyodide` you need to be on an x86 linux and have both Python 3.10 and Python 3.11 installed.
